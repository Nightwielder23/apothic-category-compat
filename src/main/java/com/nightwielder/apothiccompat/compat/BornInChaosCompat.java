...
// Born in Chaos is MCreator-generated so weapons don't extend vanilla weapon classes and would go
// uncategorized. Most follow a {name}_{shape} convention so suffix matching covers them. The three that
// don't (darkwarblade, trident_hayfork, soulbane) are listed exactly.
